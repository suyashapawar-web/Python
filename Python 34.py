...
science_notes = ["Plants need sunlight and water","The Earth moves around the Sun","Water can change into ice and steam"]
 
maths_notes = ["Addition means finding the total","Subtraction means taking away","Multiplication is repeated addition"]
