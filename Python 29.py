...
class Animal(ABC):
    ...
    #Parent constructor - store attributes shared by ALL animals
    ...
    #Abstract method - every class MUST implement this
    @abstractmethod 
    def speak(self):
        pass
